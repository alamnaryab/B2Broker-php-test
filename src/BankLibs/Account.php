...
class Account{
    ...
    public function getAccountTransactionsSortByComments($accountNumber,$direction='asc'){
    ...
    public function getAccountTransactionsSortByDate($accountNumber,$direction='asc'){
        //get unsorted transactions
        $trxs = $this->getAccountTransactionsUnsorted($accountNumber);
    ...
    public function isNotificationSubscribed($accountNumber,$type){
        //simulating database select query to get all account
        $accounts= $this->DB->accounts;
